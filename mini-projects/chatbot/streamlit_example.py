...
def resize_image(image_name):
    ...
    return st.image(new_image, use_column_width='always', output_format='png')
...
with col1:
    ...
    resize_image('images/ls1.png')
    # st.image('images/ls1.png', use_column_width='always')
...
with col2:
    ...
    resize_image('images/ts1.png')
    # st.image('images/ts1.png', use_column_width='always')
...
with col3:
    ...
    resize_image('images/ed1.png')
    # st.image('images/ed1.png', use_column_width='always')
...
with col4:
    ...
    resize_image('images/db1.png')
    # st.image('images/db1.png', use_column_width='always')
